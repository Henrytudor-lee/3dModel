        ...
        <div className="group">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1.5">
              <button
                onClick={() => handleMaterialChange('opacity', Math.max(0, (selectedObject.material.opacity ?? 1) - 0.1))}
              ...
              <input
                ...
                className={`w-12 h-6 text-center border rounded text-[11px] font-mono tabular-nums focus:outline-none transition-colors ${
                  isDark
                    ? 'bg-black/30 border-white/10 text-gray-200 focus:border-white/20'
              ...
              <button
                onClick={() => handleMaterialChange('opacity', Math.min(1, (selectedObject.material.opacity ?? 1) + 0.1))}
                className={`w-5 h-5 rounded flex items-center justify-center text-xs font-medium transition-all ${
                  isDark
                    ? 'bg-white/5 hover:bg-white/10 text-gray-400 hover:text-gray-200'
                    : 'bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-700'
          ...
          <div className="relative h-6 flex items-center">
            ...
            <div
              ...
              style={{
                background: isDark
                  ...
                  : 'linear-gradient(90deg, rgba(0,0,0,0.03) 0%, transparent 50%, rgba(0,0,0,0.03) 100%)',
              }}
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: `
                    linear-gradient(45deg, ${isDark ? '#1a1a24' : '#e5e7eb'} 25%, transparent 25%),
                    linear-gradient(-45deg, ${isDark ? '#1a1a24' : '#e5e7eb'} 25%, transparent 25%),
                    linear-gradient(45deg, transparent 75%, ${isDark ? '#1a1a24' : '#e5e7eb'} 75%),
                    linear-gradient(-45deg, transparent 75%, ${isDark ? '#1a1a24' : '#e5e7eb'} 75%)
                  `,
            ...
            <div
              ...
              style={{
                width: `${((selectedObject.material.opacity ?? 1) * 100)}%`,
                background: `linear-gradient(90deg, ${typeColor}80, ${typeColor})`,
            ...
            <input
              ...
              className="absolute inset-x-0 w-full h-6 appearance-none cursor-pointer bg-transparent"
            />

            {/* Custom thumb */}
            <div
              className="absolute w-4 h-4 rounded-full pointer-events-none shadow-lg"
              style={{
                left: `calc(${((selectedObject.material.opacity ?? 1) * 100)}% - 8px)`,
                background: `linear-gradient(135deg, ${typeColor}, ${typeColor}cc)`,
                boxShadow: `0 2px 8px ${typeColor}60, inset 0 1px 2px rgba(255,255,255,0.3)`,
              }}
            />
          </div>
        </div>
